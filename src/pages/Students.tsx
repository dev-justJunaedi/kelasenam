...
import { Search, Download, Plus, Filter, Upload, FileDown, Loader2 } from 'lucide-react';
...
export default function Students() {
    ...
    const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // Prepare data for insertion (remove id to let Supabase generate UUID if needed, 
            // or keep UUID generated by parser if using UUID)
            // Ideally we let DB generate ID, but parser generates temp ID.
            // Let's remove ID before insert to let DB handle it, or use the one we generated.
            // Since our parser generates UUID, we can try to use it.
            ...
            // Bulk insert
            const { data, error } = await supabase.from('students').insert(sanitizedStudents).select();
    ...
    const filteredStudents = students.filter(student => {
        ...
        // Handle potential missing kode_par
    ...
    // Get unique kode_par values safely
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2.5 rounded-xl font-medium shadow-sm transition-all"
